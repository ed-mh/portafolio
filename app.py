...
#             "descripcion": "Análisis exploratorio de datos (EDA) y geoespacial de la "+
#             "actividad sísmica de Chiapas y el sureste de México, "+
...
from flask import Flask, render_template, request, redirect # Las herramientas principales de Flask
...
def contacto():
    if request.method == 'POST': # Si el usuario está enviando datos...
        ...
        try:
            ...
            return redirect('/contacto') # Recargamos la página para limpiar el formulario
        except:
            return 'Hubo un error al guardar el mensaje.'
